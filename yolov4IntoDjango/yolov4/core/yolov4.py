...
import yolov4.core.common as common
import yolov4.core.backbone as backbone
from yolov4.core.config import cfg

# NUM_CLASS       = len(core.read_class_names(cfg.YOLO.CLASSES))
# STRIDES         = np.array(cfg.YOLO.STRIDES)
# IOU_LOSS_THRESH = cfg.YOLO.IOU_LOSS_THRESH
# XYSCALE = cfg.YOLO.XYSCALE
# ANCHORS = core.get_anchors(cfg.YOLO.ANCHORS)
